...
<body>
    ...
    */ 
    ...
    function task12Run() {
        ...
        // Точка вхождения, будем менять значение, чтобы знать откуда искать во втором массиве (каждый второй элемент)
        $entryPoint = 1;

        // Сравниваем каждый 3 элемент первого массива с каждым 2 элементом второго массива
        for ($i=0; $i < count($arr1); $i++) {
            // Находимм третий элемент
            if ((($i + 1) % 3) == 0) {
                if ($arr1[$i] > $arr2[$entryPoint]) {
                print_r($arr1[$i] . " больше " . $arr2[$entryPoint]);
                } elseif ($arr1[$i] < $arr2[$entryPoint]) {
                    print_r($arr1[$i] . " меньше " . $arr2[$entryPoint]);
                } else {
                    print_r($arr1[$i] . " равен " . $arr2[$entryPoint]);
                }
                print_r("<br>");
                $entryPoint += 2;
            }
